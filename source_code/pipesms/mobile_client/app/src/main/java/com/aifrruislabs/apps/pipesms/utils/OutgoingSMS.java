...
public class OutgoingSMS {
    ...
    private void clearDeliveredSMS(String smsId, String apiKey) {
        StringRequest clearDeliveredSMSRequest = new StringRequest(Request.Method.POST, ServerParam.postDeliveredSMSUrl,
    ...
    private void clearSentSMS(String smsId, String apiKey) {
        StringRequest clearSentSMSRequest = new StringRequest(Request.Method.POST,  ServerParam.postSentSMSUrl,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        //Toasting
