package com.aifrruislabs.apps.pipesms.auth;
...
import com.aifrruislabs.apps.pipesms.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( (!smartphoneId.isEmpty()) && (!username.isEmpty()) && (!password.isEmpty()) ) {
    ...
    private void performAuthLogin(String smartphoneId, String username, String password, ProgressDialog progressDialog) {
        ...
        StringRequest loginRequest = new StringRequest(Request.Method.POST, ServerParam.loginUrl,
